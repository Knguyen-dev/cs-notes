...
async function main() {
	...
	await loadAuthors();
	await loadBooks();
	await loadBookInstances();
	console.log("Debug: Closing mongoose");
	mongoose.connection.close();
}

/*
+ Our Create() functions take information and save them to 
...
// Loads our genres to the database
...
// Loads our authors to the database; false indicates the value is empty.
...
async function loadBookInstances() {
	console.log("Adding authors");
	await Promise.all([
		bookInstanceCreate(
			0,
